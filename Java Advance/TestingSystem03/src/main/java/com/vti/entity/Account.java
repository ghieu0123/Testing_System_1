...
public class Account implements Serializable {
	...
	public String toString() {
		String workingNumberOfYear = employee != null ? String.valueOf(employee) : "";
		...
		return "Account [accountId=" + id + ", email=" + email + ", username=" + username + ", firstName="
				...
				+ ", position=" + position + ", salary=" + salary + ", employeeWorkingNumberOfYear=" + workingNumberOfYear + ", managerManagementNumberOfYear=" + managementNumberOfYear + ", createDate=" + createdDate + "]";
	}
}
